...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.19/24 | 192.168.255.1 |
...
| --------- | --------------- | ------------ | --------- |
| avd-test_L2Leaf1 | Vlan4094 | 10.255.252.37 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | AVD-TEST-LEAF1A_Ethernet7 | *trunk | *110-112,120-121,130-131 | *- | *- | 1 |
| Ethernet2 | AVD-TEST-LEAF1B_Ethernet7 | *trunk | *110-112,120-121,130-131 | *- | *- | 1 |
| Ethernet3 | MLAG_PEER_avd-test-L2Leaf1B_Ethernet3 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_avd-test-L2Leaf1B_Ethernet4 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet5 |  server01_ens3 | access | 110 | - | - | - |
...
!
interface Ethernet1
   description AVD-TEST-LEAF1A_Ethernet7
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description AVD-TEST-LEAF1B_Ethernet7
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description MLAG_PEER_avd-test-L2Leaf1B_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_avd-test-L2Leaf1B_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description server01_ens3
   no shutdown
...
| Port-Channel3 | MLAG_PEER_avd-test-L2Leaf1B_Po3 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_avd-test-L2Leaf1B_Po3
   no shutdown
   switchport
   switchport mode trunk
