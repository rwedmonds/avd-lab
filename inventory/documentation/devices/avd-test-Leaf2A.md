...
| --------- | --------------- | ------------ | --------- |
| avd-test_Leaf2 | Vlan4094 | 10.255.252.33 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_avd-test-Leaf2B_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_avd-test-Leaf2B_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet7 | AVD-TEST-L2LEAF2A_Ethernet1 | *trunk | *110-112,120-121,130-131 | *- | *- | 7 |
| Ethernet8 | AVD-TEST-L2LEAF2B_Ethernet1 | *trunk | *110-112,120-121,130-131 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-TEST-SPINE1_Ethernet3 | routed | - | 172.31.255.129/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-TEST-SPINE2_Ethernet3 | routed | - | 172.31.255.131/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_AVD-TEST-SPINE3_Ethernet3 | routed | - | 172.31.255.133/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-TEST-SPINE4_Ethernet3 | routed | - | 172.31.255.135/31 | default | 1500 | False | - | - |
...
!
interface Ethernet6
   description MLAG_PEER_avd-test-Leaf2B_Ethernet6
   no shutdown
   channel-group 5 mode active
!
interface Ethernet7
   description AVD-TEST-L2LEAF2A_Ethernet1
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description AVD-TEST-L2LEAF2B_Ethernet1
   no shutdown
   channel-group 7 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_avd-test-Leaf2B_Po5 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Loopback100 | Tenant_A_OP_Zone_VTEP_DIAGNOSTICS | Tenant_A_OP_Zone | 10.255.1.19/32 |
...
| Vlan3009 |  Tenant_A_OP_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Tenant_A_WEB_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Tenant_A_APP_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  Tenant_A_DB_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3013 |  Tenant_A_WAN_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3019 |  Tenant_B_OP_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3020 |  Tenant_B_WAN_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3029 |  Tenant_C_OP_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3030 |  Tenant_C_WAN_Zone  |  10.255.251.32/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 172.31.255.132 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.134 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_APP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_DB_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WAN_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_WEB_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_WAN_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.251.33 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_C_WAN_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_APP_Zone | 192.168.254.19:12 | 12:12 | - | - | learned | 130-131 |
| Tenant_A_DB_Zone | 192.168.254.19:13 | 13:13 | - | - | learned | 140-141 |
| Tenant_A_NFS | 192.168.254.19:10161 | 10161:10161 | - | - | learned | 161 |
| Tenant_A_OP_Zone | 192.168.254.19:10 | 10:10 | - | - | learned | 110-112 |
| Tenant_A_VMOTION | 192.168.254.19:55160 | 55160:55160 | - | - | learned | 160 |
| Tenant_A_WAN_Zone | 192.168.254.19:14 | 14:14 | - | - | learned | 150 |
| Tenant_A_WEB_Zone | 192.168.254.19:11 | 11:11 | - | - | learned | 120-121 |
| Tenant_B_OP_Zone | 192.168.254.19:20 | 20:20 | - | - | learned | 210-211 |
| Tenant_B_WAN_Zone | 192.168.254.19:21 | 21:21 | - | - | learned | 250 |
| Tenant_C_OP_Zone | 192.168.254.19:30 | 30:30 | - | - | learned | 310-311 |
| Tenant_C_WAN_Zone | 192.168.254.19:31 | 31:31 | - | - | learned | 350 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Tenant_A_APP_Zone | 192.168.254.19:12 | connected |
| Tenant_A_DB_Zone | 192.168.254.19:13 | connected |
| Tenant_A_OP_Zone | 192.168.254.19:10 | connected |
| Tenant_A_WAN_Zone | 192.168.254.19:14 | connected |
| Tenant_A_WEB_Zone | 192.168.254.19:11 | connected |
| Tenant_B_OP_Zone | 192.168.254.19:20 | connected |
| Tenant_B_WAN_Zone | 192.168.254.19:21 | connected |
| Tenant_C_OP_Zone | 192.168.254.19:30 | connected |
| Tenant_C_WAN_Zone | 192.168.254.19:31 | connected |
...
router bgp 65102
   ...
   neighbor 10.255.251.33 description avd-test-Leaf2B
   neighbor 172.31.255.128 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.128 remote-as 65001
   neighbor 172.31.255.128 description avd-test-Spine1_Ethernet3
   neighbor 172.31.255.130 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.130 remote-as 65001
   neighbor 172.31.255.130 description avd-test-Spine2_Ethernet3
   neighbor 172.31.255.132 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.132 remote-as 65001
   neighbor 172.31.255.132 description avd-test-Spine3_Ethernet3
   neighbor 172.31.255.134 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.134 remote-as 65001
   neighbor 172.31.255.134 description avd-test-Spine4_Ethernet3
   ...
   vlan-aware-bundle Tenant_A_APP_Zone
      rd 192.168.254.19:12
      route-target both 12:12
      redistribute learned
      vlan 130-131
   !
   vlan-aware-bundle Tenant_A_DB_Zone
      rd 192.168.254.19:13
      route-target both 13:13
      redistribute learned
      vlan 140-141
   !
   vlan-aware-bundle Tenant_A_NFS
      rd 192.168.254.19:10161
      route-target both 10161:10161
      redistribute learned
      vlan 161
   !
   vlan-aware-bundle Tenant_A_OP_Zone
      rd 192.168.254.19:10
      route-target both 10:10
      redistribute learned
      vlan 110-112
   !
   vlan-aware-bundle Tenant_A_VMOTION
      rd 192.168.254.19:55160
      route-target both 55160:55160
      redistribute learned
      vlan 160
   !
   vlan-aware-bundle Tenant_A_WAN_Zone
      rd 192.168.254.19:14
      route-target both 14:14
      redistribute learned
      vlan 150
   !
   vlan-aware-bundle Tenant_A_WEB_Zone
      rd 192.168.254.19:11
      route-target both 11:11
      redistribute learned
      vlan 120-121
   !
   vlan-aware-bundle Tenant_B_OP_Zone
      rd 192.168.254.19:20
      route-target both 20:20
      redistribute learned
      vlan 210-211
   !
   vlan-aware-bundle Tenant_B_WAN_Zone
      rd 192.168.254.19:21
      route-target both 21:21
      redistribute learned
      vlan 250
   !
   vlan-aware-bundle Tenant_C_OP_Zone
      rd 192.168.254.19:30
      route-target both 30:30
      redistribute learned
      vlan 310-311
   !
   vlan-aware-bundle Tenant_C_WAN_Zone
      rd 192.168.254.19:31
...
| -------------- | --------------------- |
| Tenant_A_OP_Zone | 10.255.1.19 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Tenant_A_OP_Zone address 10.255.1.19
```
