...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-TEST-LEAF1A_Ethernet1 | routed | - | 172.31.255.112/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-TEST-LEAF1B_Ethernet1 | routed | - | 172.31.255.120/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_AVD-TEST-LEAF2A_Ethernet1 | routed | - | 172.31.255.128/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-TEST-LEAF2B_Ethernet1 | routed | - | 172.31.255.136/31 | default | 1500 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.31.255.113 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.121 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.129 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.137 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 172.31.255.113 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.113 remote-as 65101
   neighbor 172.31.255.113 description avd-test-Leaf1A_Ethernet1
   neighbor 172.31.255.121 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.121 remote-as 65101
   neighbor 172.31.255.121 description avd-test-Leaf1B_Ethernet1
   neighbor 172.31.255.129 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.129 remote-as 65102
   neighbor 172.31.255.129 description avd-test-Leaf2A_Ethernet1
   neighbor 172.31.255.137 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.137 remote-as 65102
   neighbor 172.31.255.137 description avd-test-Leaf2B_Ethernet1
