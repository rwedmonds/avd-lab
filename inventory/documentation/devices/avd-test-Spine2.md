...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-TEST-LEAF1A_Ethernet2 | routed | - | 172.31.255.114/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-TEST-LEAF1B_Ethernet2 | routed | - | 172.31.255.122/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_AVD-TEST-LEAF2A_Ethernet2 | routed | - | 172.31.255.130/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_AVD-TEST-LEAF2B_Ethernet2 | routed | - | 172.31.255.138/31 | default | 1500 | False | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 172.31.255.115 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.123 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.131 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.31.255.139 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 172.31.255.115 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.115 remote-as 65101
   neighbor 172.31.255.115 description avd-test-Leaf1A_Ethernet2
   neighbor 172.31.255.123 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.123 remote-as 65101
   neighbor 172.31.255.123 description avd-test-Leaf1B_Ethernet2
   neighbor 172.31.255.131 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.131 remote-as 65102
   neighbor 172.31.255.131 description avd-test-Leaf2A_Ethernet2
   neighbor 172.31.255.139 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.139 remote-as 65102
   neighbor 172.31.255.139 description avd-test-Leaf2B_Ethernet2
