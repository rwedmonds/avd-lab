...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.22/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| RE-AVD-L2Leaf1 | Vlan4094 | 192.168.252.40 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | RE-AVD-LEAF1A_Ethernet8 | *trunk | *110-112,120-121 | *- | *- | 1 |
| Ethernet2 | RE-AVD-LEAF1B_Ethernet8 | *trunk | *110-112,120-121 | *- | *- | 1 |
| Ethernet3 | MLAG_PEER_RE-AVD-L2Leaf1A_Ethernet3 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_RE-AVD-L2Leaf1A_Ethernet4 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet5 | Host1_Ethernet2 | *access | *110 | *- | *- | 5 |
...
!
interface Ethernet1
   description RE-AVD-LEAF1A_Ethernet8
   no shutdown
   channel-group 1 mode on
!
interface Ethernet2
   description RE-AVD-LEAF1B_Ethernet8
   no shutdown
   channel-group 1 mode on
!
interface Ethernet3
...
| Port-Channel3 | MLAG_PEER_RE-AVD-L2Leaf1A_Po3 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_RE-AVD-L2Leaf1A_Po3
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  192.168.252.41/31  |  -  |  -  |  -  |  -  |  -  |
