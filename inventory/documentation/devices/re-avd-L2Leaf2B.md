...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.24/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| RE-AVD-L2Leaf2 | Vlan4094 | 192.168.252.44 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | RE-AVD-LEAF2A_Ethernet8 | *trunk | *110-112,120-121 | *- | *- | 1 |
| Ethernet2 | RE-AVD-LEAF2B_Ethernet8 | *trunk | *110-112,120-121 | *- | *- | 1 |
| Ethernet3 | MLAG_PEER_RE-AVD-L2Leaf2A_Ethernet3 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_RE-AVD-L2Leaf2A_Ethernet4 | *trunk | *- | *- | *['MLAG'] | 3 |
| Ethernet5 | avd-svr01_ens5 | *access | *121 | *- | *- | 5 |
| Ethernet6 | Host2_Ethernet2 | *access | *110 | *- | *- | 6 |
...
!
interface Ethernet1
   description RE-AVD-LEAF2A_Ethernet8
   no shutdown
   channel-group 1 mode on
!
interface Ethernet2
   description RE-AVD-LEAF2B_Ethernet8
   no shutdown
   channel-group 1 mode on
!
interface Ethernet3
   description MLAG_PEER_RE-AVD-L2Leaf2A_Ethernet3
   no shutdown
   channel-group 3 mode on
!
interface Ethernet4
   description MLAG_PEER_RE-AVD-L2Leaf2A_Ethernet4
   no shutdown
   channel-group 3 mode on
!
interface Ethernet5
   description avd-svr01_ens5
   no shutdown
...
| Port-Channel3 | MLAG_PEER_RE-AVD-L2Leaf2A_Po3 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_RE-AVD-L2Leaf2A_Po3
   no shutdown
   switchport
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4094 |  default  |  192.168.252.45/31  |  -  |  -  |  -  |  -  |  -  |
