...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.18/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| RE-AVD-Leaf2 | Vlan4094 | 192.168.252.32 | Port-Channel5 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | MLAG_PEER_RE-AVD-Leaf2A_Ethernet5 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet6 | MLAG_PEER_RE-AVD-Leaf2A_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 5 |
| Ethernet7 | RE-AVD-L2LEAF2A_Ethernet2 | *trunk | *110-112,120-121 | *- | *- | 7 |
| Ethernet8 | RE-AVD-L2LEAF2B_Ethernet2 | *trunk | *110-112,120-121 | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_RE-AVD-SPINE1_Ethernet4 | routed | - | 192.168.0.137/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_RE-AVD-SPINE2_Ethernet4 | routed | - | 192.168.0.139/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_RE-AVD-SPINE3_Ethernet4 | routed | - | 192.168.0.141/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_RE-AVD-SPINE4_Ethernet4 | routed | - | 192.168.0.143/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | MLAG_PEER_RE-AVD-Leaf2A_Po5 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Loopback100 | App_Zone_VTEP_DIAGNOSTICS | App_Zone | 192.168.100.20/32 |
| Loopback101 | Op_Zone_VTEP_DIAGNOSTICS | Op_Zone | 192.168.101.20/32 |
...
| Vlan3099 |  App_Zone  |  192.168.251.33/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3199 |  Op_Zone  |  192.168.251.33/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.168.251.33/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.168.252.33/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.0.136 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.138 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.140 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.142 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.251.32 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 192.168.251.32 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | App_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 192.168.251.32 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Op_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| App_Zone | 192.168.254.20:100 | 100:100 | - | - | learned | 110-112 |
| Op_Zone | 192.168.254.20:200 | 200:200 | - | - | learned | 120-121 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| App_Zone | 192.168.254.20:100 | connected |
| Op_Zone | 192.168.254.20:200 | connected |
...
router bgp 65102
   ...
   neighbor 192.168.0.136 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.136 remote-as 65001
   neighbor 192.168.0.136 description RE-AVD-Spine1_Ethernet4
   neighbor 192.168.0.138 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.138 remote-as 65001
   neighbor 192.168.0.138 description RE-AVD-Spine2_Ethernet4
   neighbor 192.168.0.140 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.140 remote-as 65001
   neighbor 192.168.0.140 description RE-AVD-Spine3_Ethernet4
   neighbor 192.168.0.142 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.142 remote-as 65001
   neighbor 192.168.0.142 description RE-AVD-Spine4_Ethernet4
   neighbor 192.168.251.32 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 192.168.251.32 description RE-AVD-Leaf2A
   ...
   vlan-aware-bundle App_Zone
      rd 192.168.254.20:100
      route-target both 100:100
      redistribute learned
      vlan 110-112
   !
   vlan-aware-bundle Op_Zone
      rd 192.168.254.20:200
...
| -------------- | --------------------- |
| App_Zone | 192.168.100.20 |
| Op_Zone | 192.168.101.20 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf App_Zone address 192.168.100.20
ip address virtual source-nat vrf Op_Zone address 192.168.101.20
```
