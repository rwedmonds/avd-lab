...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.11/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_RE-AVD-LEAF1A_Ethernet1 | routed | - | 192.168.0.112/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_RE-AVD-LEAF1B_Ethernet1 | routed | - | 192.168.0.120/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_RE-AVD-LEAF2A_Ethernet1 | routed | - | 192.168.0.128/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_RE-AVD-LEAF2B_Ethernet1 | routed | - | 192.168.0.136/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_RE-AVD-BRDRLEAF1A_Ethernet1 | routed | - | 192.168.0.144/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_RE-AVD-BRDRLEAF1B_Ethernet1 | routed | - | 192.168.0.152/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_RE-AVD-LEAF1A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_RE-AVD-LEAF1B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_RE-AVD-LEAF2A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_RE-AVD-LEAF2B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_RE-AVD-BRDRLEAF1A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_RE-AVD-BRDRLEAF1B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.254.11/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.0.113 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.121 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.129 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.137 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.145 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.153 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.0.113 remote-as 65101
   neighbor 192.168.0.113 description RE-AVD-Leaf1A_Ethernet1
   neighbor 192.168.0.121 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.121 remote-as 65101
   neighbor 192.168.0.121 description RE-AVD-Leaf1B_Ethernet1
   neighbor 192.168.0.129 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.129 remote-as 65102
   neighbor 192.168.0.129 description RE-AVD-Leaf2A_Ethernet1
   neighbor 192.168.0.137 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.137 remote-as 65102
   neighbor 192.168.0.137 description RE-AVD-Leaf2B_Ethernet1
   neighbor 192.168.0.145 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.145 remote-as 65103
   neighbor 192.168.0.145 description RE-AVD-BrdrLeaf1A_Ethernet1
   neighbor 192.168.0.153 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.153 remote-as 65103
   neighbor 192.168.0.153 description RE-AVD-BrdrLeaf1B_Ethernet1
