...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.255.14/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_RE-AVD-LEAF1A_Ethernet4 | routed | - | 192.168.0.118/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_RE-AVD-LEAF1B_Ethernet4 | routed | - | 192.168.0.126/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_RE-AVD-LEAF2A_Ethernet4 | routed | - | 192.168.0.134/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_RE-AVD-LEAF2B_Ethernet4 | routed | - | 192.168.0.142/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_RE-AVD-BRDRLEAF1A_Ethernet4 | routed | - | 192.168.0.150/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_RE-AVD-BRDRLEAF1B_Ethernet4 | routed | - | 192.168.0.158/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_RE-AVD-LEAF1A_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_RE-AVD-LEAF1B_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_RE-AVD-LEAF2A_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_RE-AVD-LEAF2B_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_RE-AVD-BRDRLEAF1A_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_RE-AVD-BRDRLEAF1B_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.254.14/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 192.168.0.119 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.127 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.135 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.143 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.151 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.0.159 | 65103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65001
   ...
   neighbor 192.168.0.119 remote-as 65101
   neighbor 192.168.0.119 description RE-AVD-Leaf1A_Ethernet4
   neighbor 192.168.0.127 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.127 remote-as 65101
   neighbor 192.168.0.127 description RE-AVD-Leaf1B_Ethernet4
   neighbor 192.168.0.135 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.135 remote-as 65102
   neighbor 192.168.0.135 description RE-AVD-Leaf2A_Ethernet4
   neighbor 192.168.0.143 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.143 remote-as 65102
   neighbor 192.168.0.143 description RE-AVD-Leaf2B_Ethernet4
   neighbor 192.168.0.151 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.151 remote-as 65103
   neighbor 192.168.0.151 description RE-AVD-BrdrLeaf1A_Ethernet4
   neighbor 192.168.0.159 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.159 remote-as 65103
   neighbor 192.168.0.159 description RE-AVD-BrdrLeaf1B_Ethernet4
