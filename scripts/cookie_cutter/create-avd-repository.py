...
if __name__ == "__main__":
    ...
    cookiecutter_json = {
        ...
        'csv': {
            # load inventory
            'inventory': read_csv_file('./inventory.csv'),
            # load cabling plan
            'cabling_plan': read_csv_file('./cabling_plan.csv'),
            # load server connections
            'server_list': read_csv_file('./servers.csv'),
            # load server port profiles
            'server_port_profiles': read_csv_file('./server_port_profiles.csv'),
            # load tenants and vrfs
            'tenants_vrfs': read_csv_file('./tenants_and_vrfs.csv'),
            # load vlans and svis
            'vlans_svis': read_csv_file('./vlans_and_svis.csv')
        }
    ...
    cookiecutter_json.update({
        'general': read_yaml_file('./general_parameters.yml')
    })
